...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:XXX-DEUS\n'
            + 'ORG:O Criador CariocaOFC;\n'
            + 'TEL;type=CELL;type=VOICE;waid=5599445750:+55 48-9944-5750\n'
            + 'END:VCARD'
...
limitt = 50
ban = []
userpremium = ["554899445750@s.whatsapp.net"] //ubah nomer kalian
...
const getRegisteredRandomId = () => {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["554899445750@s.whatsapp.net"] // owner number ubah aja
		...
		case 'daftar':
			...
			if (isBanned) return reply(mess.only.benned)
				...
				ben = '```Lista dos Banidos``` :\n'
					...
					break 
				case 'premiumlist':
				prem = '```Lista Users Premium  🖤𝘎𝘖𝘓𝘋𝘖𝘍𝘍-🅱🅾🆃🆅3🖤``` :\n'
